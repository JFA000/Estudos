...
print(f"The sum of the numbers is: {NumberSum:.2f}")
print(f"The max of the numbers is: {NumberMax:.2f}")
print(f"The min of the numbers is: {NumberMin:.2f}")
print(f"The avg of the numbers is: {NumberAvg:.2f}")